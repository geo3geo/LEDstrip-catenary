...
Hang your WS2812 LED strip from each end so it forms a natuaral catenary and the Arduino software will use LEDs to simulate 
two balls dropping down to the cenre, crossing over, then travelling up the other side. However due to 'frictional losses' 
they won't climb all the way back up. Gradually they lose energy and languish at the bottom and disappear. The cycle then 
